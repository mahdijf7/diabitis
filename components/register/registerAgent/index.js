...
const RegisterAgent = ({ provinceOptions, citiesList }) => {
  ...
  const list = [
    {
      tag: (
        <CustomInputFill name="firstname" text={t.registerAgent.firstname} />
      ),
      sm: 6,
    },
    {
    ...
    },
    {
      tag: (
        <CustomInputFill
          name="nationalCode"
          text={t.registerAgent.nationalCode}
        />
      ),
      sm: 6,
    },
    {
      tag: <CustomInputFill name="mobile" text={t.registerAgent.mobile} />,
      sm: 6,
    },
    {
    ...
    {
      tag: <CustomInputFill name="email" text={t.registerAgent.email} />,
      sm: 6,
    },
    {
      tag: (
        ...
        <Form>
          ...
          >
            ...
            <Grid item textAlign="center" xs={12} sm={6}>
              <CustomInputFill name="code" text={t.registerAgent.code} />
            </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <SubmitButtonFill fullWidth={true} disabled={isLoading}>
                  {!isLoading ? (
                    ...
                    >
                      {t.registerAgent.requestConfirmation}
                    </Typography>
                  ) : (
