...
const RegisterCompany = ({ provinceOptions, citiesList }) => {
  ...
  const list = [
    {
      tag: (
        <CustomInputFill name="firstname" text={t.registerCompany.firstname} />
      ),
      sm: 6,
    },
    {
      tag: (
        <CustomInputFill name="lastname" text={t.registerCompany.lastname} />
      ),
      sm: 6,
    },
    {
      tag: (
        <CustomInputFill
          name="nationalCode"
          text={t.registerCompany.nationalCode}
        />
      ),
      sm: 6,
    },
    {
      tag: <CustomInputFill name="mobile" text={t.registerCompany.mobile} />,
      sm: 6,
    },
    {
      tag: (
    ...
    {
      tag: <CustomInputFill name="email" text={t.registerCompany.email} />,
      sm: 6,
    },
    {
      tag: (
        <SelectWrapper
          ...
          text={t.registerCompany.province}
    ...
    },
    {
      tag: (
        <CustomInputFill
          name="address"
          text={t.registerCompany.address}
          multiline
        />
      ),
      sm: 12,
        ...
        <Form>
          ...
          >
            ...
            <Grid item textAlign="center" xs={12} sm={6}>
              <CustomInputFill name="code" text={t.registerCompany.code} />
            </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <SubmitButtonFill fullWidth={true} disabled={isLoading}>
                  {!isLoading ? (
                    ...
                    >
                      {t.registerCompany.requestConfirmation}
                    </Typography>
                  ) : (
